...
wget -O "pbdb_data.csv" "http://www.paleobiodb.org/data1.2/occs/list.csv?&base_name=$1&taxon_reso=species&idspcmod=!ng,af,cf,sl,if,eg,qm,qu&show=ident,class,refattr,acconly"